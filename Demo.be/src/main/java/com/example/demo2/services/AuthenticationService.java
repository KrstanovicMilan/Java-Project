...
import com.example.demo2.enums.TokenTypeEnum;
import com.example.demo2.models.*;
import com.example.demo2.repositories.ITokenRepository;
...
public class AuthenticationService {
    ...
    public AuthenticationResponseModel register (RegisterRequestModel request){
        ...
        if(user != null){
            throw new UsernameNotFoundException("User alredy exist");
        }

        user = UserModel.builder()
                .firstName(request.getFirstName())//RoleEnum.User
