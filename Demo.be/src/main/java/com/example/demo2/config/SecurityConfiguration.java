...
import static com.example.demo2.enums.PermissionEnum.*;
import static com.example.demo2.enums.RoleEnum.*;
...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .permitAll()
                .requestMatchers("/cars/create")
                .permitAll()
                .requestMatchers("/cars/rent")
                .permitAll()
